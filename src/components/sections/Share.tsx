...
export default function Share({ groomName, brideName, date }: ShareProps) {
  ...
  const handleShareKakao = () => {
    window.Kakao.Share.sendDefault({
      ...
      imageUrl:
        'https://www.google.com/url?sa=i&url=https%3A%2F%2Fkr.freepik.com%2Ffree-photos-vectors%2F%25EA%25B2%25B0%25ED%2598%25BC&psig=AOvVaw2kDz8tLItGcsk6UlAMQFKH&ust=1743074391271000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCKjs0aHQp4wDFQAAAAAdAAAAABAd',
      link: {
